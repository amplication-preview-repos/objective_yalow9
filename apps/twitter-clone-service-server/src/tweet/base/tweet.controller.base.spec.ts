...
const CREATE_INPUT = {
  ...
  authorTweet: "exampleAuthorTweet",
  content: "exampleContent",
  contentTweet: "exampleContentTweet",
  createdAt: new Date(),
  id: "exampleId",
  timestamp: new Date(),
  timestampTweet: new Date(),
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  author: "exampleAuthor",
  ...
  test("POST /tweets", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        timestampTweet: CREATE_RESULT.timestampTweet.toISOString(),
      ...
      .expect([
        {
          ...
          timestampTweet: FIND_MANY_RESULT[0].timestampTweet.toISOString(),
  ...
  test("GET /tweets/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        timestampTweet: FIND_ONE_RESULT.timestampTweet.toISOString(),
